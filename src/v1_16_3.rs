...
define_protocol!(753, Packet753, RawPacket753, RawPacket753Body, Packet753Kind => {
    ...
    // wiki.vg is wrong on the ID. 0x28 is confirmed correct
    PlayCreativeInventoryAction, 0x28, Play, ServerBound => PlayCreativeInventoryActionSpec {
        slot: i16,
        clicked_item: Slot
    },
    // wiki.vg is wrong on the ID. 0x29 is confirmed correct
    PlayUpdateJigsawBlock, 0x29, Play, ServerBound => PlayUpdateJigsawBlockSpec {
        ...
        target_pool: String,
        final_state: String,
        joint_type: UpdateJigsawJointType
    },
...
proto_varint_enum!(StatisticKind,
    ...
    21 :: Drop,
    22 :: DamageDealt,
    23 :: DamageDealtAbsorbed,
    24 :: DamageDealtResisted,
    25 :: DamageTaken,
    26 :: DamageBlockedByShield,
    27 :: DamageAbsorbed,
    28 :: DamageResisted,
    29 :: Deaths,
    30 :: MobKills,
    ...
    40 :: CleanBanner,
    41 :: CleanShulkerBox,
    42 :: InteractWithBrewingstand,
    43 :: InteractWithBeacon,
    44 :: InspectDropper,
    45 :: InspectHopper,
    46 :: InspectDispenser,
    47 :: PlayNoteblock,
    48 :: TuneNoteblock,
    49 :: PotFlower,
    50 :: TriggerTrappedChest,
    51 :: OpenEnderchest,
    52 :: EnchantItem,
    53 :: PlayRecord,
    54 :: InteractWithFurnace,
    55 :: InteractWithCraftingTable,
    56 :: OpenChest,
    57 :: SleepInBed,
    58 :: OpenShulkerBox,
    59 :: OpenBarrel,
    60 :: InteractWithBlastFurnace,
    61 :: InteractWithSmoker,
    62 :: InteractWithLectern,
    63 :: InteractWithCampfire,
    64 :: InteractWithCartographyTable,
    65 :: InteractWithLoom,
    66 :: InteractWithStonecutter,
    67 :: BellRing,
    68 :: RaidTrigger,
    69 :: RaidWin,
    70 :: InteractWithAnvil,
    71 :: InteractWithGrindstone,
    72 :: TargetHit,
    73 :: InteractWithSmithingTable
);
...
proto_str_enum!(UpdateJigsawJointType,
    "rollable" :: Rollable,
    "aligned" :: Aligned
);
